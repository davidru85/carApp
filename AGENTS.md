...
- **Remaining Phase 3:** `E3-02`, `E3-03`, `E3-08`, `E3-04`, `E3-12`,
  ...
  open pull request #68 awaiting the owner's gated review and all ten required checks; `E3-03` is
  implemented on the open `story/E3-03-core-sync-engine` branch and its gated pull request, awaiting
  the owner's review and the same ten checks. `E3-14` and
  `E3-15` are the two
