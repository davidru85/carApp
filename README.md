...
> **Project status:** **Phase 1 complete; Phase 2 open.** `E1-01` through `E1-13`, `E3-06`, `E3-01`, `E0-07`, `E2-01` and `E2-02` have delivered the SQLDelight database, complete local Vehicle and Fuel Entry repositories, Fuel Entry validation, reviewed full-to-full consumption, executable provider decoupling, reviewed Firestore rules, the native walking skeleton, both native Vehicle and Fuel Entry flows, device-local settings, deterministic shared graph-test teardown, executable native locale-provider behavior coverage, the complete provider-free auth contracts with their auth-backed owner context, and the Firebase Auth credential exchange. `E2-03`, the F-1 onboarding flow with native Google and Apple acquisition, merged on 2026-09-06 through pull request #54; `E2-06`, local owner adoption, is in progress. The project builds on both platforms and `main` is protected by ten required CI checks.
...
| 2 - Authentication **(open)** | E2-01, E2-02 and E2-03 are complete; E2-06 is in progress; E2-04, E2-07 and E2-05 remain | Adoption and normal linking preserve data; confirmed collisions preserve the current anonymous snapshot |
