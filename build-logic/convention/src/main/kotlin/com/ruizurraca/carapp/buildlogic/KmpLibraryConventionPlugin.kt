...
class KmpLibraryConventionPlugin : Plugin<Project> {
    override fun apply(target: Project): Unit =
        with(target) {
            ...
            // Name every test as it starts. A test that stalls then appears as the last line before a
            // silent step timeout, which is otherwise undiagnosable from CI: without this, a stalled
            // suite is killed with no test result and no indication of which test is responsible.
