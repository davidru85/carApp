...
| D-71 | iOS simulator signing | Use normal Xcode simulator signing without a committed team or identity so Firebase Auth acceptance exercises Keychain persistence. | Accepted |
