...
| D-184 | Android background-work library | `androidx.work:work-runtime` is pinned at `2.11.2` and consumed by `:androidApp` only, for the `enqueueUniqueWork(SYNC_WORK, KEEP)` periodic cadence of `§9.1`. | Accepted |
